...
#include "ChristmasJamCharacter.generated.h"

class UInputComponent;

UCLASS(config=Game)
class AChristmasJamCharacter : public ACharacter
{
	GENERATED_BODY()
...
public:
	...
	TSubclassOf<class AChristmasJamProjectile> ProjectileClass;
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = Gameplay)
	class USoundBase* PresentThrow;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = Gameplay)
	class USoundBase* PresentDrop;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = Gameplay)
		class USoundBase* PresentPick;
